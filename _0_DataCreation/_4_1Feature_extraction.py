...
n_components = My_pca['pca'].n_components_
...
class Feature_extractor():
  ...
  n_lines = {'fold1_NA_pca': 76773,
             'fold2_NA_pca': 92481,
             'fold3_NA_pca': 27006,
             'testSet_NA_pca': 173512}
...
if __name__ == '__main__':
  ...
  features = ['dx','dx2','dw','dw2', 'mean', 'max','min', 'last']
  
  #Training sets
  datasets = ['fold1_NA_pca','fold2_NA_pca','fold3_NA_pca']
